...
st.set_page_config(
    page_title="AI CV Filtering & Analysis",
    page_icon="📄",
    layout="wide",
    initial_sidebar_state="expanded"
     # menu_items={
     #     'Get Help': 'https://www.linkedin.com/in/ayoub-bouhouch/',
     #     'Report a bug': "https://www.linkedin.com/in/ayoub-bouhouch/",
     #     'About': "AI CV Filtering & Analysis System v1.0"
     # }
)
...
def render_ui():
    ...
    # st.caption(
    #    "Platform inteligente pour l'analyse et le filtrage des CVs basée sur l'IA"
    # )
    ...
    tab1, tab2, tab3 = st.tabs(["📄 Analyse CV", "🏆 Resultats", "📊 Dashboard"])    
        ...
        with st.spinner("Analyse des CVs en cours..."):
            ...
            for file in uploaded_files:
                    ...
                    if len(extracted_text.strip()) < 50:
                        st.warning(
                            f"Le texte extrait du fichier {file.name} est trop court pour une analyse fiable."
                        )
                        continue
